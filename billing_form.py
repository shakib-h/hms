...
class Billing:
    def __init__(self,master):
        ...
        self.lbldid = Label(self.LoginFrame,text="DATE DISCHARGED(YYYY-MM-DD)",font="Helvetica 14 bold",bg=helper.bg,bd=22)
        ...
        self.button2 = Button(self.LoginFrame, text="UPDATE DISCHARGE DATE",width =25,font="Helvetica 14 bold",bg=helper.bg,command = self.UPDATE_DATE)
        self.button2.grid(row=1,column=3)
        
        self.lbltreat= Label(self.LoginFrame,text="TREATMENT",font="Helvetica 14 bold",bg=helper.bg,bd=22)
        ...
        self.lblcode_t1= Label(self.LoginFrame,text="TREATMENT CODE",font="Helvetica 14 bold",bg=helper.bg,bd=22)
        ...
        self.lblmed = Label(self.LoginFrame,text="MEDICINE",font="Helvetica 14 bold",bg=helper.bg,bd=22)
        ...
        self.med_t1= Label(self.LoginFrame,text="MEDICINE QUANTITY",font="Helvetica 14 bold",bg=helper.bg,bd=22)
    ...
    def GEN_BILL(self):
        ...
        for ii in u:
            ...
            self.uu=Label(self.LoginFrame,font="Helvetica 14 bold",bg=helper.bg,bd=22,text=ii[0])
